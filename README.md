...
*   **🎨 自定义光标外观**
    *   **多种形状**：内置圆形、空心圆环、正方形、星星、爱心、三角形等多种几何形状。
...
*   **☄️ 动态拖尾效果**
    *   **3 种拖尾样式**：线性拖尾、粒子发射、图片重复。
    *   **长度调节**：支持调节拖尾的停留时长。
    *   **4 种粒子预设**：扩散、火焰（上升）、雪花（下落）、魔法闪烁。
...
| 拖尾样式 | 线性拖尾、粒子发射、图片重复 | 线性拖尾 |
| 粒子特效预设 | 扩散、火焰、雪花、魔法闪烁 | 扩散 |

## 🛠️ 技术优化 (Optimizations)
